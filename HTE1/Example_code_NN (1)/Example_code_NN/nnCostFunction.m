...
% Reshaping Theta1
Theta1 = reshape(nn_params(1:98), 2, 49); %same thing as above but looks clear with the numbers visible

% Reshaping Theta2 
% The starting index for Theta2 would be 99, right after Theta1's elements
Theta2 = reshape(nn_params(99:end), 7, 3);
